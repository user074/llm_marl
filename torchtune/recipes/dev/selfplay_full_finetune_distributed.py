...
class SelfplayFullGRPOFinetuneRecipeDistributed(FTRecipeInterface):
    """
    ...
    def evaluate_trajectory_batched(
        ...
        with torch.no_grad():
            for batch_start in range(0, self.batch_size, self._forward_batch_size):
                ...
                start_idx = batch_start * self.grpo_samples
                end_idx = (batch_start + self._forward_batch_size) * self.grpo_samples
    ...
    def train(self) -> None:
        ...
        for curr_epoch in range(self._epochs_run, self.total_epochs):
            ...
            for idx, batch in enumerate(self._dataloader):
                ...
                # print("Shape after generation:", trajectory.query_responses.shape)
                ...
                for _ in range(self._ppo_epochs):
                    ...
                    #Maximize the reward of the evaluator
                    eval_loss.backward()
                    #Clip the gradients
                ...
                self.cleanup_after_step(evaluated_trajectory, grpo_stats)
...
def recipe_main(cfg: DictConfig) -> None:
    ...
    recipe = SelfplayFullGRPOFinetuneRecipeDistributed(cfg=cfg)
    config.log_config(recipe_name="SelfplayFullGRPOFinetuneRecipeDistributed", cfg=cfg)
